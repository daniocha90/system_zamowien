      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {products.length === 0 ? (
          ...
          products.map(product => (
            <div key={product.id || product._id} className="border rounded-lg p-4 hover:shadow-lg transition-shadow">
              <img 
      ...
      {cartItems.length > 0 && (
        <div className="border-t pt-6">
          ...
          <div className="space-y-3">
            {cartItems.map(item => (
              <div key={item.id || item._id} className="flex items-center justify-between border-b pb-3">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="text-right min-w-24">
                    <div className="font-semibold">
                      {((item.priceGross * item.quantity * (1 - (item.discount || 0) / 100))).toFixed(2)} PLN
                    </div>
                    {(item.discount > 0) && (
